          ...
          <template v-slot:default>
            ...
            <tbody>
              ...
              >
                ...
                <td>
                  {{ receipt.date_start | formatDMY }} - {{ receipt.date_end | formatDMY }}
                </td>
                <td>{{ receipt.employee.position ?  receipt.employee.position.name : '' }}</td>
                <td>{{ receipt.created_at | formatDMY }}</td>
                <td>
                  <v-menu
                    transition="slide-y-transition"
                    bottom
                    v-if="$can('employee_receipt_show') || $can('employee_receipt_delete')"
                  >
                      <template v-slot:activator="{ on, attrs }">
                      ...
                      <v-list nav dense>
                          <v-list-item
                            v-on:click="_edit(receipt.id)"
                            v-if="$can('employee_receipt_show')"
                          >
                              <v-list-item-icon>
                          ...
                          <v-list-item
                            ...
                            v-if="$can('employee_receipt_delete')"
                          >
                              <v-list-item-icon>
                          ...
                          <v-list-item
                            ...
                            v-if="$can('employee_receipt_download') && $can('employee_receipt_show')"
                          >
                              <v-list-item-icon>
                                  <v-icon color="btn-primary">mdi-download</v-icon>
                              </v-list-item-icon>
                              <v-list-item-content>
...
export default {
  ...
  methods: {
    ...
    _edit(id){
      this.$can('employee_receipt_show')
        ? this.$router.push({
